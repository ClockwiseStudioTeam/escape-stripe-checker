  ...
  for (const charge of charges.data) {
    ...
    if (!existingPayment) {
      ...
      const mailOptions = {
        ...
        <h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><strong>Pronto para começar?</strong></h1>
        </td>
        </tr>
        </table>
        ...
        <div align="center" class="alignment" style="line-height:10px"><img src="https://cdn.discordapp.com/attachments/1036355509739073680/1104539517345607750/treasure-chest-svgrepo-com.png" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" width="100"/></div>
        </td>
        </tr>
        </table>
        ...
        <p style="margin: 0;">Obrigado <strong>${charge.billing_details.name}</strong> por te juntares à nossa caça ao tesouro com os teus amigos!<br/><br/>Para participar, você precisará baixar o aplicativo Loquiz em sua loja de aplicativos (Google Play ou App Store) e inserir os dados de acesso que foram enviados para você por e-mail.<br/><br/><br/>Certifique-se de inserir as informações corretas e seguir as instruções para começar a jogar. A Loquiz é uma plataforma fácil de usar que permitirá que você participe do jogo em tempo real e interaja com outros jogadores.<br/><br/>Se você tiver alguma dúvida ou problema para acessar o jogo, não hesite em entrar em contato connosco por e-mail ou telefone.<br/><br/>Boa sorte e divirta-se!<br/><br/>Atenciosamente,<br/><br/><br/>Os piratas da Treasure Hunters! Arrrg!</p>
        </div>
        </td>
        </tr>
        </table>
